...
import { CISSP_DOMAINS, LearningStatus } from '@/data/cissp/types'
      ...
      {currentTerm ? (
        <div className="space-y-4">
          ...
          >
            {!flipped ? (
              <>
                <span className="inline-block bg-sky-100 text-sky-700 px-2 py-0.5 rounded-full text-xs font-medium mb-4">
                  {currentTerm.domain}
                </span>
